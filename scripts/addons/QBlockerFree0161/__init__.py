...
bl_info = {
    ...
    "warning": "",
    "category": "Add Mesh",
    "doc_url": "https://qblockerdocs.readthedocs.io/qblocker_free.html"
}
...
class QBlockerAddonPreferences(bpy.types.AddonPreferences):
    ...
    iscursorparam: bpy.props.BoolProperty(
        name="Show parameters at cursor",
        description="Show the parameters next to the mouse cursor.",
        default=True
    )
    ...
    isignore_wire_bool: bpy.props.BoolProperty(
        name="Ignore Wire and Bounds objects",
        description="If object viewport visibility is set to Wire or Bound, the ray will be recasted.",
        default=True
    )
    ...
    wpcursor_bool: bpy.props.BoolProperty(
        name="Align 3D cursor",
        description="Align 3d cursor to working plane.",
        default=True
    )
    ...
    def draw(self, context):
        ...
        general_box.row().prop(self, "iscursorparam")
        ...
        # raycast settings
        raycast_box = layout.box()
        raycast_box.label(text="RayCast settings")
        raycast_box.row().prop(self, "object_ignorebehind", expand=True)
        raycast_box.row().prop(self, "isignore_wire_bool")
        ...
        wplane_box.row().prop(self, "wpcursor_bool")

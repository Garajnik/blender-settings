...
class MACHIN3toolsPreferences(bpy.types.AddonPreferences):
    ...
    if bpy.app.version >= (4, 2, 0):
        ...
        screencast_use_skribe: BoolProperty(name="Use SKRIBE (external, preferred)", default=True)
    ...
    def draw_general(self, layout):
        global has_skribe, has_screencast_keys, hardops, boxcutter
        ...
        if boxcutter is None:
            boxcutter = get_addon('BoxCutter')[0]

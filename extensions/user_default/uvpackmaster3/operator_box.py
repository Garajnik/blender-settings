...
class UVPM3_OT_RenderBoxesGeneric(Operator):
    ...
    def modal(self, context, event):
        ...
        try:
            ...
            self.report({'ERROR'}, UVPM3_OT_Engine.UNEXPECTED_ERROR_MSG)
...
class UVPM3_OT_FinishBoxRendering(Operator):
...
class UVPM3_OT_ModifyTargetBox(Operator):
...
class UVPM3_OT_MoveGroupingSchemeBox(GroupingSchemeAccess, UVPM3_OT_MoveTargetBoxEngine, MoveTargetBoxProperties, AccessDescIdAttrMixin):

    bl_idname = 'uvpackmaster3.move_grouping_scheme_box'


class UVPM3_OT_MoveCustomTargetBox(UVPM3_OT_MoveTargetBoxEngine, MoveTargetBoxProperties, CustomTargetBoxAccess):

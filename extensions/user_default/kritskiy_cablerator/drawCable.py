                ...
                for key in self.enums.keys():
                    if event.type == key:
                        ...
                        if key == 'H':
                            ...
                            context.scene.tool_settings.curve_paint_settings.depth_mode = self.enums[key]['items'][self.enums[key]['cur_value']][0]
                        elif key == 'F':
                            context.scene.tool_settings.curve_paint_settings.error_threshold = self.enums[key]['items'][self.enums[key]['cur_value']][0]
                        elif key == 'U':
                            context.scene.tool_settings.curve_paint_settings.curve_type = self.enums[key]['items'][self.enums[key]['cur_value']][0]

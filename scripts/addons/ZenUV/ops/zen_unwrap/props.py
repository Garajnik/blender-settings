...
class ZenUnwrapProps:
    ...
    def __init__(self, context) -> None:
        ...
        scene_level_props = context.scene.zen_uv.op_zen_unwrap_sc_props  # type: ZUV_ZenUnwrapOpSceneProps

        # Scene level Properties
        self.Mark: bool = scene_level_props.MarkUnwrapped
        self.ProcessingMode: str = scene_level_props.ProcessingMode  # in ("SEL_ONLY", "WHOLE_MESH", "SEAM_SWITCH", "URP_VERTICES")
        self.Pack: bool = scene_level_props.packAfUnwrap
        self.TdMode: str = scene_level_props.post_td_mode

        self.fill_holes: bool = scene_level_props.fill_holes
        self.correct_aspect: bool = scene_level_props.correct_aspect

        # Global Zen UV Properties
        self.UnwrapMethod: str = global_prefs.UnwrapMethod  # in ("ANGLE_BASED", "CONFORMAL")
...
class ZenUnwrapState:
    ...
    def __init__(self, context, objs) -> None:
        ...
        self.PROPS: ZenUnwrapProps = ZenUnwrapProps(context)
    ...
    def _detect_opm(self, context):
        if self.PROPS.ProcessingMode == "SEAM_SWITCH":
            scene_level_props = context.scene.zen_uv.op_zen_unwrap_sc_props  # type: ZUV_ZenUnwrapOpSceneProps
            scene_level_props.post_td_mode = 'SKIP'

    ...
    if create_in_out:
        ...
        if ZenPolls.version_since_4_0_0:
            if hasattr(_overrider, 'interface'):
                _overrider.interface.new_socket('MainShader', in_out='INPUT', socket_type='NodeSocketColor')
                _overrider.interface.new_socket('MixedShader', in_out='OUTPUT', socket_type='NodeSocketColor')
            else:
                return False
        else:
...
def repair_zen_overrider(context):
    ...
    if _overrider:
        ...
        if create_zen_global_overrider_node_tree(context, _overrider, create_in_out=False) is False:
            return False
    else:
